...
输出严格 JSON：{"summary":"简短说明","clarification":null,"tasks":[{"title":"具体可完成的动作","dayOffset":0,"reason":"可检查的产出与依据","sourceIds":[],"existingItemId":null}]}。
dayOffset 必须小于 horizonDays 且从 0 开始；最多12项。
