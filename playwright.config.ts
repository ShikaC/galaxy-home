...
export default defineConfig({
  ...
  webServer: [
    {
      command: `API_PORT=3011 VITE_API_PORT=3011 VITE_PORT=5183 GALAXY_DATA_DIR=${compactDataDirectory} GALAXY_CLOCK_NOW=2026-08-05T14:00:00.000Z VITE_DISABLE_REACT_DEVTOOLS=1 npm run dev`,
